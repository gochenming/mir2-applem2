...
//         MessageDlg (FFileName + ' 灌冷돕。', mtWarning, [mbOk], 0);
      end;
   end;
end;
...
//        DebugOutStr('[Exception] TWMImages.LoadDxImage 1');
      end;
...
//          DebugOutStr('[Exception] TWMImages.LoadDxImage 11');
//          DebugOutStr(E.Message);
      ...
      pdximg.surface.TransparentColor := 0;
        ...
        on e: Exception do begin
//          DebugOutStr('[Exception] TWMImages.LoadDxImage 12');
//          DebugOutStr(E.Message);
        end;
      end;
   end else begin //
      ...
      try
        ...
        on e: Exception do begin
//          DebugOutStr('[Exception] TWMImages.LoadDxImage ' + IntToStr(nErrorCode));
//          DebugOutStr(E.Message);
//          DebugOutStr(format('W:%d,H:%d',[imgInfo.nWidth,imgInfo.nHeight]));
        end;
      end;
      finally
...
//  DebugOutStr('[Exception] TWMImages.LoadDxImage 2 - ' + IntToStr(imginfo.nWidth * imgInfo.nHeight));
end;
end;
