...
type
  TWILColorFormat = (WILFMT_A4R4G4B4, WILFMT_A1R5G5B5, WILFMT_R5G6B5);
...
const
  ...
  ColorFormat: array[TWILColorFormat] of _D3DFORMAT = (D3DFMT_A4R4G4B4, D3DFMT_A1R5G5B5, D3DFMT_R5G6B5);
...
type
  ...
  TWILType = (t_wmM2Def, t_wmM2Def16, t_wmM2wis, t_wmMyImage, t_wmM3Def, t_wmWoool, t_wm521g);
...
begin
  ...
  SafeFillChar(FDxTextureArr[0], FImageCount * SizeOf(TDXTexture), #0);
  Result := True;
end;
