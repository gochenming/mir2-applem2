...
var
  ...
  g_WHumEffects: array[0..HUMEFFECTCOUNT] of TWMImages;
...
{$IFEND}
  ...
  g_WHumHorseWingImages.Initialize;
  ...
  g_WDefMagIconImages.Initialize;
  ...
  g_WDefMagIcon2Images.Initialize;
...
//  g_WMagic4Images.ChangeAlpha := True;
 ...
 // g_WMagic9Images.ChangeAlpha := True;
  ...
  g_WItemEffectImages.Initialize;
  ...
  g_WcboHumEffectImages.Initialize();
