    ...
    if Tag in [Low(OpenBoxItems)..High(OpenBoxItems)] then begin
      ...
      if OpenBoxShowEffect and OpenGetItem then begin
        if OpenBoxEffectIdx < 10 then begin
          if (OpenBoxIndex + 8) = Tag then begin
            d := g_WMain2Images.Images[230 + OpenBoxEffectIdx];
            if d <> nil then begin
      ...
      if (OpenBoxItems[Tag].ItemType <> bit_None) and (OpenBoxSelectIndex = Tag) then begin
        if ((GetTickCount - dwndBox.AppendTick) mod 300 > 150) and (not OpenBoxMove) then
          d := g_WMain3Images.Images[601 + Tag * 2]
        else d := g_WMain3Images.Images[600 + Tag * 2];
        if d <> nil then begin
...
{$IF Var_Interface = Var_Mir2}
  ...
  DMakeItemTreeViewUpDown.UpButton.SetImgIndex(g_WUI1Images, 1613);
  DMakeItemTreeViewUpDown.DownButton.SetImgIndex(g_WUI1Images, 1616);
  DMakeItemTreeViewUpDown.MoveButton.SetImgIndex(g_WUI1Images, 1610);
...
{$IF Var_Interface = Var_Mir2}
  ...
  DItemUnsealClose.SetImgIndex(g_WMainImages, 64);
...
{$IF Var_Interface = Var_Mir2}
  ...
  if d <> nil then begin
    ...
    DGuildDlg.Left := (SCREENWIDTH - d.Width) div 2;
    DGuildDlg.Top := (SCREENHEIGHT - d.Height) div 2;
  end;
  ...
  DGDSortComboBox.SetImgIndex(g_WUI1Images, 2750);
...
{$IF Var_Interface = Var_Mir2}
  ...
  DGuildNoticeUpDown.UpButton.SetImgIndex(g_WUI1Images, 1613);
  DGuildNoticeUpDown.DownButton.SetImgIndex(g_WUI1Images, 1616);
  DGuildNoticeUpDown.MoveButton.SetImgIndex(g_WUI1Images, 1610);
...
{$IF Var_Interface = Var_Mir2}
  ...
  DGuildAllyUpDown.UpButton.SetImgIndex(g_WUI1Images, 1613);
  DGuildAllyUpDown.DownButton.SetImgIndex(g_WUI1Images, 1616);
  DGuildAllyUpDown.MoveButton.SetImgIndex(g_WUI1Images, 1610);
  ...
  DGuildWarUpDown.UpButton.SetImgIndex(g_WUI1Images, 1613);
  DGuildWarUpDown.DownButton.SetImgIndex(g_WUI1Images, 1616);
  DGuildWarUpDown.MoveButton.SetImgIndex(g_WUI1Images, 1610);
...
{$IF Var_Interface = Var_Mir2}
  ...
  DGuildMemberUpDown.UpButton.SetImgIndex(g_WUI1Images, 1613);
  DGuildMemberUpDown.DownButton.SetImgIndex(g_WUI1Images, 1616);
  DGuildMemberUpDown.MoveButton.SetImgIndex(g_WUI1Images, 1610);
  ...
  DUpDownGuildMember.UpButton.SetImgIndex(g_WUI1Images, 1613);
  DUpDownGuildMember.DownButton.SetImgIndex(g_WUI1Images, 1616);
  DUpDownGuildMember.MoveButton.SetImgIndex(g_WUI1Images, 1610);
...
{$IF Var_Interface = Var_Mir2}
  ...
  if d <> nil then begin
    ...
    DGameSetup.Left := (SCREENWIDTH - d.Width) div 2;
    DGameSetup.Top := (SCREENHEIGHT - d.Height) div 2;
  end;
  DGSClose.SetImgIndex(g_WMainImages, 64);
  DGSClose.Left := 459;
  DGSClose.Top := 0;

  DGSConfig.SetImgIndex(g_WMain2Images, 608);
  DGSConfig.Top := 14;
  DGSConfig.Left := 10 + 48 * DGSConfig.Tag;
  ;
  DGSFunction.SetImgIndex(g_WMain2Images, 608);
  DGSFunction.Top := 14;
  DGSFunction.Left := 10 + 48 * DGSFunction.Tag;
  DGSProtect.SetImgIndex(g_WMain2Images, 608);
  DGSProtect.Top := 14;
  DGSProtect.Left := 10 + 48 * DGSProtect.Tag;
  DGSItems.SetImgIndex(g_WMain2Images, 608);
  DGSItems.Top := 14;
  DGSItems.Left := 10 + 48 * DGSItems.Tag;
  DGSMagics.SetImgIndex(g_WMain2Images, 608);
  DGSMagics.Top := 14;
  DGSMagics.Left := 10 + 48 * DGSMagics.Tag;
  dbtnGSSay.SetImgIndex(g_WMain2Images, 608);
  dbtnGSSay.Top := 14;
...
{$IF Var_Interface = Var_Mir2}
  ...
  if d <> nil then begin
    ...
    dwndMission.Left := SCREENWIDTH - d.Width;
    dwndMission.Top := (SCREENHEIGHT - d.Height) div 2;
  end;
  dbtnMissionClose.SetImgIndex(g_WMainImages, 64);
  ...
  DUDwnTreeMission.UpButton.SetImgIndex(g_WUI1Images, 1613);
  DUDwnTreeMission.DownButton.SetImgIndex(g_WUI1Images, 1616);
  DUDwnTreeMission.MoveButton.SetImgIndex(g_WUI1Images, 1610);
  ...
  DUDwnMissionInfo.UpButton.SetImgIndex(g_WUI1Images, 1613);
  DUDwnMissionInfo.DownButton.SetImgIndex(g_WUI1Images, 1616);
  DUDwnMissionInfo.MoveButton.SetImgIndex(g_WUI1Images, 1610);
{$ELSE}
...
{$IFEND}
  ...
  if d <> nil then begin
    ...
    dwndBox.Left := (SCREENWIDTH - d.Width) div 2;
    dwndBox.Top := (SCREENHEIGHT - d.Height) div 2;
  end;
...
{$IF Var_Interface = Var_Mir2}
  ...
  if d <> nil then begin
    ...
    DWindowTop.Left := (SCREENWIDTH - d.Width) div 2;
    DWindowTop.Top := 0;
  end;

  DTopClose.SetImgIndex(g_WMainImages, 64);
  DTopClose.Left := 543;
  DTopClose.Top := 33;
...
{$ELSE}
  ...
  if d <> nil then begin
    ...
    DWindowTop.Left := (SCREENWIDTH - d.Width) div 2;
    DWindowTop.Top := (SCREENHEIGHT - d.Height) div 2;
  end;
