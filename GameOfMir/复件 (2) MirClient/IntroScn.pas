...
{$IFEND}
  if (d <> nil) and (g_boCanDraw) then begin
    ...
    with g_DXCanvas do begin
      TextOut(SCREENWIDTH - TextWidth(CLIENTUPDATETIME) - 1, SCREENHEIGHT - TextHeight(CLIENTUPDATETIME) - 1, clYellow, CLIENTUPDATETIME);
{$IF Var_Interface = Var_Mir2}
...
{$ELSE}
    ...
    if (d <> nil) and (g_boCanDraw) then
      MSurface.Draw(15, SCREENHEIGHT div m_nMaxFrame * (m_nCurFrame + 1) - SCREENHEIGHT + 3, d.ClientRect, d, True);
{$IFEND}
...
{$IF Var_Interface = Var_Mir2}
        TextOut(SCREENWIDTH div 2 + 3 - TextWidth(svname) div 2, 8, clWhite, svname);
{$ELSE}
        TextOut(SCREENWIDTH div 2 {405} - TextWidth(svname) div 2, (SCREENHEIGHT - 600) div 2 + 18 {8}, clWhite, svname);
{$IFEND}
        ...
        with g_DXCanvas do begin
          if n = 0 then begin
            with MSurface do begin
              TextOut((SCREENWIDTH - 800) div 2 + 117 {117}, (SCREENHEIGHT - 600) div 2 + 492 + 2 {492+2}, clWhite, ChrArr[n].UserChr.Name);
              TextOut((SCREENWIDTH - 800) div 2 + 117 {117}, (SCREENHEIGHT - 600) div 2 + 523 {523}, clWhite, IntToStr(ChrArr[n].UserChr.Level));
              TextOut((SCREENWIDTH - 800) div 2 + 117 {117}, (SCREENHEIGHT - 600) div 2 + 553 {553}, clWhite, GetJobName(ChrArr[n].UserChr.Job));
            end;
          end
          else begin
            with MSurface do begin
              TextOut((SCREENWIDTH - 800) div 2 + 671 {671}, (SCREENHEIGHT - 600) div 2 + 492 + 4 {492+4}, clWhite, ChrArr[n].UserChr.Name);
              TextOut((SCREENWIDTH - 800) div 2 + 671 {671}, (SCREENHEIGHT - 600) div 2 + 523 + 2 {525}, clWhite, IntToStr(ChrArr[n].UserChr.Level));
              TextOut((SCREENWIDTH - 800) div 2 + 671 {671}, (SCREENHEIGHT - 600) div 2 + 553 + 2 {555}, clWhite, GetJobName(ChrArr[n].UserChr.Job));
            end;
          end;
        end;
      end;
