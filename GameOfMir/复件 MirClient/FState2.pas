...
begin
  ...
  //提示框
  {DWndHint.Height := ADDSAYHEIGHT * ADDSAYCOUNT;
  DWndHint.Left := 600;
  DWndHint.Width := ADDSAYWHDTH;
  DWndHint.Top := 250; }
  DWndHint.Height := MISSIONHINTHEIGHT;
  DWndHint.Left := MISSIONHINTX;
...
{$IF Var_Interface = Var_Mir2}
  ...
  DBotShopClose.SetImgIndex(g_WMainImages, 64);
  ...
  DBotList1.SetImgIndex(g_WMain3Images, 210);
  DBotList1.Left := 242;
  DBotList1.Top := 46;
  DBotList1.Visible := False;
  DBotList2.SetImgIndex(g_WMain3Images, 303);
  DBotList2.Left := 409;
  DBotList2.Top := 14;
  DBotList3.SetImgIndex(g_WMain3Images, 300);
  DBotList3.Left := 235;
  DBotList3.Top := 14;
  DBotList4.SetImgIndex(g_WMain3Images, 301);
  DBotList4.Left := 293;
  DBotList4.Top := 14;
  DBotList5.SetImgIndex(g_WMain3Images, 299);
  DBotList5.Left := 177;
  DBotList5.Top := 14;
  DBotList6.SetImgIndex(g_WMain3Images, 302);
  DBotList6.Left := 351;
  DBotList6.Top := 14;
  ...
  DButFront2.SetImgIndex(g_WMainImages, 388);
  DButFront2.Left := 197;
  DButFront2.Top := 349;
  DButFront2.OnDirectPaint := DBotShopCloseDirectPaint;
  DButNext2.SetImgIndex(g_WMainImages, 387);
  DButNext2.Left := 287;
  DButNext2.Top := 349;
...
{$IF Var_Interface = Var_Mir2}
  ...
  if d <> nil then begin
    ...
    DWinEmail.Left := SCREENWIDTH - d.Width;
    DWinEmail.Top := SCREENHEIGHT - d.Height - 200;
  end;
  DEMailClose.SetImgIndex(g_WMainImages, 64);
  ...
  DUpDownEMail.UpButton.SetImgIndex(g_WUI1Images, 1613);
  DUpDownEMail.DownButton.SetImgIndex(g_WUI1Images, 1616);
  DUpDownEMail.MoveButton.SetImgIndex(g_WUI1Images, 1610); //114
{$ELSE}
...
{$IF Var_Interface = Var_Mir2}
  ...
  DEMailReadClose.SetImgIndex(g_WMainImages, 64);
  ...
  DEMailReadUpDown.UpButton.SetImgIndex(g_WUI1Images, 1613);
  DEMailReadUpDown.DownButton.SetImgIndex(g_WUI1Images, 1616);
  DEMailReadUpDown.MoveButton.SetImgIndex(g_WUI1Images, 1610); //114
{$ELSE}
...
{$IF Var_Interface = Var_Mir2}
  ...
  DEMailNewClose2.SetImgIndex(g_WMainImages, 64);
  ...
  DEmailNewUpDown.UpButton.SetImgIndex(g_WUI1Images, 1613);
  DEmailNewUpDown.DownButton.SetImgIndex(g_WUI1Images, 1616);
  DEmailNewUpDown.MoveButton.SetImgIndex(g_WUI1Images, 1610); //114
  ...
  DEMailNameComboBox.SetImgIndex(g_WUI1Images, 2750);
...
{$IF Var_Interface = Var_Mir2}
  ...
  if d <> nil then begin
    ...
    DWinFriend.Left := 160;
    DWinFriend.Top := SCREENHEIGHT - d.Height - 199;
  end;
  DFriClose.SetImgIndex(g_WMainImages, 64);
  DFriClose.Left := 169;
  DFriClose.Top := 0;
  ...
  DFriendUpDown.UpButton.SetImgIndex(g_WUI1Images, 1613);
  DFriendUpDown.DownButton.SetImgIndex(g_WUI1Images, 1616);
  DFriendUpDown.MoveButton.SetImgIndex(g_WUI1Images, 1610); //114
...
{$ELSE}
  ...
  if d <> nil then begin
    ...
    DWinFriend.Left := SCREENWIDTH - d.Width;
    DWinFriend.Top := (SCREENHEIGHT - d.Height) div 2;
  end;
...
{$IFEND}
  ...
  if d <> nil then begin
    ...
    DMatrixCardWnd.Left := (SCREENWIDTH - d.Width) div 2;
    DMatrixCardWnd.Top := (SCREENHEIGHT - d.Height) div 2;
  end;
...
{$IF Var_Interface = Var_Mir2}
  ...
  if d <> nil then begin
    ...
    DWinUpLoad.Left := (SCREENWIDTH - d.Width) div 2;
    DWinUpLoad.Top := (SCREENHEIGHT - d.Height) div 2;
  end;

  DUpLoadClose.SetImgIndex(g_WMainImages, 64);
  ...
  DUpDownUpLoad.UpButton.SetImgIndex(g_WUI1Images, 1613);
  DUpDownUpLoad.DownButton.SetImgIndex(g_WUI1Images, 1616);
  DUpDownUpLoad.MoveButton.SetImgIndex(g_WUI1Images, 1610);
{$ELSE}
...
{$IF Var_Interface = Var_Mir2}
  ...
  if d <> nil then begin
    ...
    DWndUserShop.Left := SCREENWIDTH - d.Width;
    DWndUserShop.Top := (SCREENHEIGHT - d.Height) div 2;
  end;
  ...
  DUserShopClose2.SetImgIndex(g_WMainImages, 64);
  ...
  DUpDownUserShop.UpButton.SetImgIndex(g_WUI1Images, 1613);
  DUpDownUserShop.DownButton.SetImgIndex(g_WUI1Images, 1616);
  DUpDownUserShop.MoveButton.SetImgIndex(g_WUI1Images, 1610);
{$ELSE}
...
{$IF Var_Interface = Var_Mir2}
  ...
  if d <> nil then begin
    ...
    DReadUserShop.Left := (SCREENWIDTH - d.Width) div 2;
    DReadUserShop.Top := (SCREENHEIGHT - d.Height) div 2;
  end;

  DReadShopClose.SetImgIndex(g_WMainImages, 64);
  ...
  DReadShopUpDown.UpButton.SetImgIndex(g_WUI1Images, 1613);
  DReadShopUpDown.DownButton.SetImgIndex(g_WUI1Images, 1616);
  DReadShopUpDown.MoveButton.SetImgIndex(g_WUI1Images, 1610);
{$ELSE}
...
{$IF Var_Interface = Var_Mir2}
  ...
  DStorageClose.SetImgIndex(g_WMainImages, 64);
...
{$IF Var_Interface = Var_Mir2}
  ...
  if d <> nil then begin
    ...
    DWndDeath.Left := (SCREENWIDTH - d.Width) div 2;
    DWndDeath.Top := (SCREENHEIGHT - d.Height) div 2;
  end;
...
{$ELSE}
  ...
  if d <> nil then begin
    ...
    DWndDeath.Left := (SCREENWIDTH - d.Width) div 2 - 5;
    DWndDeath.Top := SCREENHEIGHT div 2 + (SCREENHEIGHT div 2 - d.Height) div 2 - 10;
  end;
...
{$IF Var_Interface = Var_Mir2}
  ...
  if d <> nil then begin
    ...
    DWndBar.Left := (SCREENWIDTH - d.Width) div 2 - 5;
    DWndBar.Top := SCREENHEIGHT - d.Height - 205;
  end;
{$ELSE}
  ...
  if d <> nil then begin
    ...
    DWndBar.Left := (SCREENWIDTH - d.Width) div 2 - 5;
    DWndBar.Top := SCREENHEIGHT div 2 + (SCREENHEIGHT div 2 - d.Height) div 2 - 10;
  end;
{$IFEND}
  ...
  DWndWeb.Left := 0;
  DWndWeb.Top := 0;
  DWndWeb.Width := SCREENWIDTH;
  DWndWeb.Height := SCREENHEIGHT;
  dBtWebClose.SetImgIndex(g_WMain99Images, 143);
  dBtWebClose.Left := SCREENWIDTH - dBtWebClose.Width;
  dBtWebClose.Top := 0;
...
{$IF Var_Interface = Var_Mir2}
  dbtnSelectChr.SetImgIndex(g_WMainImages, 136);
  dbtnSelectChr.Left := 534;
  ...
  dbtnExitGame.SetImgIndex(g_WMainImages, 138);
  dbtnExitGame.Left := 564;
...
begin
  FsUrl := sUrl;
  DWndWeb.Width := nWidth;
  DWndWeb.Height := nHeight;
  DWndWeb.Left := (SCREENWIDTH - nWidth) div 2;
  DWndWeb.Top := (SCREENHEIGHT - nHeight) div 2;
...
begin
  {if g_WebInfo.g_PayUrl <> '' then begin
    OpenWeb(g_WebInfo.g_PayUrl, SCREENWIDTH, SCREENHEIGHT);
  end;      }
  FrmWEB.wb.UISettings.EnableScrollBars := False;
  OpenWeb(g_WebInfo.g_PayUrl + '?n=' + LoginScene.m_sLoginId + '&t=' + IntToStr(GetTickCount), SCREENWIDTH, SCREENHEIGHT);
      ...
      with Window do begin
        ...
        if d <> nil then begin
          ...
          if r > 0 then
            ...
            rect.Right := 0;
          //dsurface.Draw(667, SCREENHEIGHT - 77, rc, d, FALSE);
...
var
  ...
  begin
    ...
    if CompareText(Script.sParam1, 'CHECKFLAG') = 0 then begin
      Result := GetMissionFalgStatus(Script.nParam2) = Script.nParam3;
    end else
...
begin
  if boVisible then begin
    FrmDlg.DItemBagShop.Caption := {$IF Var_Interface = Var_Default}'关闭摆摊界面'{$ELSE}'摆摊界面'{$IFEND};
    if (g_MySelf <> nil) and (not g_MySelf.m_boShop) then
      RefShopSellItems;
  end else begin
    FrmDlg.DItemBagShop.Caption := {$IF Var_Interface = Var_Default}'打开摆摊界面'{$ELSE}'摆摊界面'{$IFEND};
    if (g_MySelf <> nil) and (not g_MySelf.m_boShop) then
      ClearShopSellItems;
  end;
